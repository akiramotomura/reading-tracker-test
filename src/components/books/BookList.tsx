    ...
    return (
      <div className="animate-fadeIn">
        <button 
          ...
          className="flex items-center text-gray-600 mb-4 px-2 py-1 rounded-lg hover:bg-gray-100"
        >
          ...
          <div className="flex flex-col sm:flex-row gap-6">
            <div className="w-full sm:w-1/3">
              {selectedBook.coverImage ? (
                <img
                  ...
                  onError={(e) => {
                    ...
                    if (parent) {
                      ...
                      placeholder.className = 'w-full aspect-[3/4] bg-gray-200 rounded-lg flex flex-col items-center justify-center text-gray-400 p-4';
                ...
                <div className="w-full aspect-[3/4] bg-gray-200 rounded-lg flex flex-col items-center justify-center text-gray-400 p-4">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-4">
        {displayBooks.map((book) => (
          <div
            ...
            className="bg-white rounded-lg shadow-sm border border-gray-100 hover:shadow-md transition-shadow relative cursor-pointer active:scale-[0.98]"
          >
